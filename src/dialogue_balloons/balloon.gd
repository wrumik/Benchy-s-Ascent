...
@export var unknown_portrait_path: String = "res://src/sprites/portraits/unknown_portrait.png"
...
func apply_dialogue_line() -> void:
	...
	var portrait_path: String = "res://src/sprites/portraits/%s.png" % dialogue_line.character.to_lower()
	if FileAccess.file_exists(portrait_path):
		portrait.texture = load(portrait_path)
	else:
		portrait.texture = load(unknown_portrait_path)
